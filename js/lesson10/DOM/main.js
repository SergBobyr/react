...
//     divEl.setAttribute('class','members' );
//     document.body.append(divEl);
// divEl.innerText=`name:${item.name} surname: ${item.surname} age: ${item.age} info: ${item.info}
//  photo: ${item.photo}`
// }
...
//     allDiv.append(monthDuration)
//     let hourDuration = document.createElement('div')
//     hourDuration.innerHTML = `${item. hourDuration}`
//     allDiv.append(hourDuration);
...
// let li = document.getElementsByClassName('menu')[0]
// for (const liElement of arr) {
//    let liEl = document.createElement('li');
//    liEl.innerText = liElement;
//    li.append(liEl)
// }
...
// btn.onclick = ()=>{
//     if(input.value<18){alert('this is children')}}
